...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 14482823;
    var PACKAGE_UUID = '7b861b83-eb16-48cc-9cec-c7f1e345a7ef';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(16692, 32348, 0, 0).open('GET', '/level1');
    new DataRequest(32348, 55240, 0, 0).open('GET', '/level2');
    new DataRequest(55240, 85980, 0, 0).open('GET', '/level3');
    new DataRequest(85980, 346876, 0, 0).open('GET', '/mainData');
    new DataRequest(346876, 348254, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(348254, 354706, 0, 0).open('GET', '/resources.assets');
    new DataRequest(354706, 6800638, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(6800638, 9200691, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(9200691, 10815331, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(10815331, 10820495, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(10820495, 10825851, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(10825851, 11112719, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(11112719, 12405135, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(12405135, 13980171, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(13980171, 14482823, 0, 0).open('GET', '/Resources/unity_builtin_extra');
