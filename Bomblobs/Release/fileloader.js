...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 12043217;
    var PACKAGE_UUID = '75ab9927-a0df-447e-9862-611995c58b54';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(337144, 416832, 0, 0).open('GET', '/mainData');
    new DataRequest(416832, 416853, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(416853, 422629, 0, 0).open('GET', '/resources.assets');
    new DataRequest(422629, 8781149, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(8781149, 8788005, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(8788005, 8794861, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(8794861, 8801717, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(8801717, 8808573, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(8808573, 8815441, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(8815441, 8822309, 0, 0).open('GET', '/sharedassets6.assets');
    new DataRequest(8822309, 9965529, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9965529, 11540565, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(11540565, 12043217, 0, 0).open('GET', '/Resources/unity_builtin_extra');
