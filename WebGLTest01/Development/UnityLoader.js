...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL_Dev.data';
    var REMOTE_PACKAGE_BASE = 'WebGL_Dev.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4369737;
      var PACKAGE_UUID = '391ca45e-94fa-4a5a-acfc-9cb64e6d33db';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 1468492, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(1468492, 1468785, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1468785, 1475740, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1475740, 3467140, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3467140, 4342112, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4342112, 4369737, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL_Dev.data');

    };
    Module['addRunDependency']('datafile_WebGL_Dev.data');
