...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 39372376;
    var PACKAGE_UUID = '50bca56a-0797-4358-8d9d-c40eb9cd7470';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(565464, 600344, 0, 0).open('GET', '/level2');
    new DataRequest(600344, 699912, 0, 0).open('GET', '/level3');
    new DataRequest(699912, 1189768, 0, 0).open('GET', '/level4');
    new DataRequest(1189768, 1214264, 0, 0).open('GET', '/mainData');
    new DataRequest(1214264, 1214285, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1214285, 1821685, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(1821685, 3753663, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(3753663, 13286583, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(13286583, 28030419, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(28030419, 34143163, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(34143163, 36204980, 0, 0).open('GET', '/sharedassets3.resource');
    new DataRequest(36204980, 36209952, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(36209952, 36215080, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(36215080, 37294688, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(37294688, 38869724, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(38869724, 39372376, 0, 0).open('GET', '/Resources/unity_builtin_extra');
